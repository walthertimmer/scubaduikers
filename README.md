...
door middel van FastAPI en Sqlite (litestream) een basic setup die de workload voorlopig aan moet kunnen. SQLModel voor database setup aangezien verwachting is dat het minimaal zal zijn. 
